...
<img width="432" height="883" alt="Image" src="https://github.com/user-attachments/assets/685a4ac2-5b37-4f86-bbc3-907329f470e9" />
...
Certifique-se de ter o SDK do .NET 8 instalado e acesso a uma instância do SQL Server (o LocalDB do Visual Studio funciona perfeitamente).

Faça o clone do repositório: git clone [URL_DO_REPO]

Abra a solução no Visual Studio 2022 ou VS Code.

No arquivo appsettings.json, configure a DefaultConnection para apontar para o seu banco de dados.

Certifique-se de que possui o EF Core Tools instalado e adicione os pacotes NuGet na versão 8.0.x: `Microsoft.EntityFrameworkCore.Design` e `Microsoft.EntityFrameworkCore.SqlServer`.

No Package Manager Console (ou no terminal do EF), rode: Update-Database. O Entity Framework criará as tabelas via Migrations.

Rode o projeto (F5 ou `dotnet run`).
